            ...
            <div className='flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-6 text-white'>
                <div className='flex items-center justify-center gap-2'>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <span className='font-bold text-yellow-200 animate-pulse'>UP YO 95% OFF!</span>
                    </div>
                    <div className='bg-white text-red-600 px-4 py-1 rounded-full font-bold text-sm hover:bg-yellow-100 transition-colors shadow-lg cursor-pointer'
                    onClick={()=>
                        router.push('/')
                    }>
                        SHOP NOW!
