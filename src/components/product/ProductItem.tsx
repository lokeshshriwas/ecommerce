      ...
      <div className="p-4">
        ...
        <div className="flex flex-col">
          ...
          <div className="text-xs text-green-500 font-semibold mb-2">
                ...
                ) % 500}+ sold in last 24h
                </div>

          <button className="w-full bg-gradient-to-r from-red-600 via-orange-500 to-red-600 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all cursor-pointer">GRAB IT NOW!</button>
          <div className="text-cs text-red-500 text-center mt-1 animate-pulse">⚡ Limited time offer!</div>
        </div>
      </div>
    </div>
  );
